module.exports = {
    ...
    execute(command, args, bot, msg, Discord) {
        commands(command, args, bot, msg, Discord);
    }
}

function commands(command, args, bot, msg, Discord) {
    switch (command) {
        ...
        case 'cat':
            bot.commands.get('cat').message(msg);
            return;
        ...
        case 'clown':
            bot.commands.get('clown').message(msg);
            return;

        case 'rabbit':
            bot.commands.get('rabbit').message(msg);
            return;

        case 'you':
            bot.commands.get('you').message(msg);
            return;

        case 'cringe':
            bot.commands.get('cringe').message(msg);
            return;
        ...
        case 'gypsy':
            bot.commands.get('gypsy').gypsy(msg);
            return;
